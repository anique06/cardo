...
const learningOutcomes = [
  {
    title:
      "Describe the phases of the ventricular cardiac action potential, including the ion movements and membrane channels responsible for each phase.",
    path: "#lo1",
  },
  {
    title:
      "Explain the physiological basis of the plateau phase and refractory period, and discuss their importance in ensuring coordinated cardiac contraction and preventing tetanus.",
    path: "#lo2",
  },
  {
    title:
      "Apply knowledge of cardiac action potential to interpret the effects of changes on cardiac electrical activity.",
    path: "#lo3",
  },
];
...
const learningOutcomes2 = [
  {
    title:
      "Explain the mechanisms underlying cardiac muscle contraction and relaxation.",
    path: "#lo21",
  },
  {
    title:
      "Describe the intrinsic and extrinsic mechanisms that regulate cardiac contractility.",
    path: "#lo22",
  },
  {
    title:
      "Interpret the physiological and clinical significance of altered cardiac mechanical function.",
    path: "#lo23",
  },
];
      ...
      <main className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 pt-8 relative z-10">
        ...
        <header className="mb-16">
          ...
          <h1 className="font-serif text-5xl sm:text-6xl lg:text-7xl font-normal tracking-tight text-[#1F365C] leading-[1.15] max-w-4xl">
            How Does The Heart's Muscle Work
          </h1>
        </header>
